...
urlpatterns = [
	...
	# path('profiles/<uuid:profile_id>/invite/', views.profile_invite, name='profile_invite'),
	path('profiles/<uuid:profile_id>/request/', views.profile_request, name='profile_request'),
	path('profiles/<uuid:profile_id>/remove/', views.profile_remove, name='profile_remove'),
