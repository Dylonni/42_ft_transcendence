...
urlpatterns = [
    ...
    path('about_priv/', views.about_priv, name='about_priv'),
    path('about/', views.about_pub, name='about_pub'),
    path('about/dev_team_priv/', views.dev_team_priv, name='dev_team_priv'),
    path('about/dev_team/', views.dev_team_pub, name='dev_team_pub'),
    path('about/faq_priv/', views.faq_priv, name='faq_priv'),
    path('about/faq/', views.faq_pub, name='faq_pub'),
    path('about/game_rules_priv/', views.game_rules_priv, name='game_rules_priv'),
    path('about/game_rules/', views.game_rules_pub, name='game_rules_pub'),
    path('about/privacy_policy_priv/', views.privacy_policy_priv, name='privacy_policy_priv'),
    path('about/privacy_policy/', views.privacy_policy_pub, name='privacy_policy_pub'),
    path('about/terms_of_service_priv/', views.terms_of_service_priv, name='terms_of_service_priv'),
