...
expect  {"\[7m/usr/share/elasticsearch/config/elastic-stack-ca.p12\[0m"
{send -- "\r"
	exp_continue
}
}
expect { "\[52D/usr/share/elasticsearch/config/elastic-stack-ca.p12\r\r
...
expect { "\[7mlocalhost\[0m"
{send -- "\r"
	exp_continue
}}

expect { "\rlocalhost\r\r
\[?1l>\[?1000l\[?2004l\[?1h=\[?2004h"
{send -- "\[200~transcendence42\[201~"
	exp_continue
}}

expect { "\[7mtranscendence42\[0m"
{send -- "\r"
	exp_continue
}
}
expect  {"\rtranscendence42\r\r
\[?1l>\[?1000l\[?2004l\[?1h=\[?2004h"
{send -- "\[200~transcendence42\[201~"
	exp_continue
}
...
expect { "\[7m/usr/share/elasticsearch/ela\[0m\[7ms\[0m\[7mticsearch-ssl-http.zip\[0m"
{send -- "\r"
	exp_continue
}}
